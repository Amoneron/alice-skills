...
var help = ['помощь', 'что ты умеешь?', 'что ты умеешь'];
...
module.exports = async (req, res) => {
    ...
    if (help.includes(request.original_utterance.toLowerCase())) {
        resp('Моя задача – подсказывать, чем можно заняться в свободное время. По любой команде придумаю следующую идею. Например, можно сказать "Давай", "Еще" или "Дальше". По стоп-слову "Хватит" прекращу предлагать варианты.', false);
    } else 
